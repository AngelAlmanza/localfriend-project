...
type Props = {
  ...
  handleEdit: (category: ServiceCategoryResponse) => void
  handleDeleteRequest: (category: ServiceCategoryResponse) => void
}

export const ServiceCategoriesTable = ({ categories, handleDeleteRequest, handleEdit }: Props) => {
