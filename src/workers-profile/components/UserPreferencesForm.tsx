...
import { setLocaleAction } from "../../shared/actions/set-locale.action"
import { buildUserPreferencesSchema, UserPreferencesSchema } from "../schemas/user-preferences.schema"
...
export const UserPreferencesForm = ({ initialValues, id }: UserPreferencesFormProps) => {
  ...
  const t = useTranslations("Workers.profile.userPreferences")
